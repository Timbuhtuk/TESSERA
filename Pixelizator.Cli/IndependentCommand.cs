...
internal static class IndependentCommand
{
    internal const string ScaleHelp = """
        ...
        Использование: tessera resize input.png -o result.png --width 48 --height 48
          ...
          --width N             Ширина результата: положительное целое число (48).
          --height N            Высота результата: положительное целое число (48).
        ...
        Практический размер результата зависит от доступной памяти и поддержки формата.
